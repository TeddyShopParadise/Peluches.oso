...
public class InteraccionProductosUsuario {
    ...
    public static Target BTN_PEDIDOS = Target.the("Boton para validar que el pedido se creo correctamente").located(By.xpath("/html/body/div[2]/div[3]/div/ul/div[3]/div/div/div/li[1]/div/span"));
    ...
    public static Target ESTADO = Target.the("Estado seleccionado del pedido").located(By.xpath("/html/body/div[3]/div[3]/ul/li[3]"));
