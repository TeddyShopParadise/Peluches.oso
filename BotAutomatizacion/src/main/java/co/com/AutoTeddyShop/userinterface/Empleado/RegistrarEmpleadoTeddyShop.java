...
public class RegistrarEmpleadoTeddyShop {
    ...
    public static Target BTN_PELUCHESOSO = Target.the("Elegir la compañia 'Peluches.Oso'").located(By.xpath("/html/body/div[3]/div[3]/ul/li"));
    ...
    public static Target NOMBRE_EMPLEADO = Target.the("Nombre especifico del empleado recien creado usado para la validacion").located(By.xpath("//*[@id=\"root\"]/div/div/div/div/div[4]/table/tbody/tr/td[2]"));
    public static Target NUMERO_EMPLEADO = Target.the("Numero especifico del empleado recien creado").located(By.xpath("//*[@id=\"root\"]/div/div/div/div/div[4]/table/tbody/tr/td[3]"));
    //Filtrar empleado
    public static Target BUSCAR_EMPLEADO = Target.the("Verificar si el empleado se creo filtrandolo por su DNI").located(By.xpath("/html/body/div[1]/div/div/div/div/div[3]/div/div/div/input"));
}
