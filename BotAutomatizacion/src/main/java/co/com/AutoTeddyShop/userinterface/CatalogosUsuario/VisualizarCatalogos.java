...
=======
    public static Target BTN_LISTADESPLEGABLE = Target.the(" Desplegar la lista de Menu  ").located(By.xpath("//*[@id=\"root\"]/header/div/button"));

    public static Target BTN_MENU_PRODUCTOS = Target.the(" Desplegar la lista de Menu Productos ").located(By.xpath("/html/body/div[2]/div[3]/div/ul/li[2]"));

    public static Target BTN_CATALOGOS = Target.the("Ingreso seccion Catalogos").located(By.xpath("/html/body/div[2]/div[3]/div/ul/div/div/div/div/li[1]"));
