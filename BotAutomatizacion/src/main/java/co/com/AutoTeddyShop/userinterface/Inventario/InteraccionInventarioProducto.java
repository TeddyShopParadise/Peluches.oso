...
public class InteraccionInventarioProducto {
    ...
    public static Target ESTILO_PRODUCTO = Target.the("Estilo del producto recien creado").located(By.xpath("/html/body/div[1]/div/div/div/div/div[3]/div[1]/table/tbody/tr[7]/td[1]"));
