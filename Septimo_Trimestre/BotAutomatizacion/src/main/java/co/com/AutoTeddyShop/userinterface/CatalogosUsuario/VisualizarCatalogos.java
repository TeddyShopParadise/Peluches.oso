...
public class VisualizarCatalogos extends PageObject {
    ...
    public static Target BTN_PRODUCTOUSUARIO = Target.the("Boton para seleccionar la vista de producto usuario").located(By.xpath("/html/body/div[2]/div[3]/div/ul/div/div/div/div/li[2]/div/span"));
