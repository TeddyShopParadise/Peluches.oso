...
class HistorialPrecioController {
    ...
    fun crearHistorialPrecio(): String {
        println("Ingrese el precio del producto: ")
        val precio = readLine() ?.toDouble()

        println("Ingrese la fecha de inicio del precio")
        val fechaInicio = readLine() ?: ""

        println("Ingrese la fecha de fin del precio ")
        val fechaFin = readLine() ?: ""

        println("Ingrese el estado del precio (true/false)")
        val estadoPrecio = readLine()?.toBoolean() ?: false
